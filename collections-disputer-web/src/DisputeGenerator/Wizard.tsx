...
export default function Wizard() {
  const { currentDisputeIndex } = React.useContext(DisputeGeneratorContext);
  const steps = [
    {name: "Step 1: Biographical Information", component:<BiographyForm/>},
    {name: "Step 2: Dispute Details", component:<DisputeDetailsForm/>},
    {name: "Step 3: Collections Agency Details", component:<CollectionsAgencyDetailsForm/>},
    {name: "Step 4: Dispute Letter", component:<DisputeLetter/>},
    {name: "Step 5: Supporting Documents", component:<SupportingDocumentsUploader/>},
